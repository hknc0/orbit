...
import type { GameSnapshot, PlayerSnapshot, DeltaUpdate, PlayerInput } from './Protocol';

// Mock the NETWORK constant with ADAPTIVE_INTERPOLATION (bug fix for missing constant)
